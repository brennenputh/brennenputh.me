+++
title = "Programmer Things That Aren't Building The Project"
date = 2025-12-01
+++

Written as an extension to _[things that aren't doing the thing](https://strangestloop.io/essays/things-that-arent-doing-the-thing)_ because there are a lot of things that I tend to think are building the project which are in reality not building the project.
...
Letting a LLM run wild on your project is not building the project[^1].
...
[^1]: Sorry, couldn't help myself. It might be building the project, but you're not going to convince me it's building the project you should be proud of.
