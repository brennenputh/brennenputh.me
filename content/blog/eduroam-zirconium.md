...
To fix this, I finally found [this post](https://campus-rover.gitbook.io/lab-notebook/fiiva/infrastructure/linux_terminal_eduroam_setup) which describes how to connect to eduroam using `nmcli`.
