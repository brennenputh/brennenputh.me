...
Mastery therefore must be defined as follows: as a subjection to the restrictions of an object. A pillow, being a soft fabric object, cannot be used to cut a steak except with great effort[^2]. A knife, being a sharp metal object, would make an awful rest for your head[^3].
...
[^1]: Confessions Book IX, if anyone is wondering.

[^2]: If anyone tries this, please let me know, I'm curious to know how it went.

[^3]: Please don't try this one.
